...
public class HospitalController {
	...
	public String addHospitalSubmit ( @Valid @ModelAttribute ( "HospitalForm" ) final HospitalForm form,
		...
		try {
			...
			if(e.getMessage().equals("Only 5 or 9 digit zipcode allowed")) {
				result.rejectValue( "zip", "zip.notvalid", "Only 5 or 9 digit zipcode allowed" );
			}
			if(e.getMessage().equals("Name can only contain 1 to 20 alpha characters and symbols -, ', and space")) {

				result.rejectValue( "name", "name.notvalid", "Name can only contain 1 to 20 alpha characters and symbols -, ', and space" );
			}

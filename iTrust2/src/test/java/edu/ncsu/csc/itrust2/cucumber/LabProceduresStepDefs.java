...
public class LabProceduresStepDefs {
    ...
    public void goToLabProceduresPage () {
        ...
        // "document.getElementById('labProcedures').click();" );
    ...
    public void fillLabProcedureForm ( final String procName, final String procCode ) {
        ...
        // final WebElement procedureName = driver.findElement( By.id(
        // "procedurename" ) );
        // procedureName.clear();
        // procedureName.sendKeys( procName );
        // // assuming ID for this will be procedurename
        // final WebElement procedureCode = driver.findElement( By.id(
        // "procedurecode" ) );
        // procedureCode.clear();
    ...
    public void verifyProcedureCreated () {
        // assertTrue( driver.getPageSource().contains( "Lab procedure added
        // successfully" ) );
    }

    @When ( "I start fill out the form to document the office visit, including adding a lab procedure with name (.+) and code (.+)" )
